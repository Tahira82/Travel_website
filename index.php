			...
			<div class="row">
				<div class="col">
					<div class="home_search_container">
						<div class="home_search_title">Home</div>
						<div class="home_search_content">
							<form action="#" class="home_search_form" id="home_search_form">
								<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                    <div class="form-group">
                                          <label for="Place To Travel To"> Place To Travel To:</label>
                                    ...
                                    <button class="waves-effect waves-light btn submitbtn" type="start"><a href="Packages.html">START</a></button>  
                                      $sql = "SELECT Place, Days, Money FROM home";
							...
							<!--		<button class="home_search_button">start</button>       -->    
								</div>
							</form>
						</div>
					</div>
